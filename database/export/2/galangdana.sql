...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2021 at 10:24 AM
...
(4, 'Pembelian Semen untuk pondasi', '<p>Ini adalah pembelian pertama untuk proses pembangunan</p>', '', NULL, '2021-12-02 05:11:02', '2021-12-12 01:06:07', 2, '2021-12-12 00:00:00');
...
(1, 'Pembangunan pesantren LKS Al-Hikmah Majalaya', 'pembangunan-pesantren-lks-al-hikmah-majalaya', 2, 50000000, 100000, 'Kiki Agustin', NULL, '2021-11-30 18:44:43', '2021-12-13 03:21:52', '<p>Sudah satu tahun pembangunan wakaf pesantren terhenti, dikarenakan dana,nya tidak ada maka dari itu kami selaku panitia ingin mengajak para orang baik untuk membereskan pembangunan ini minimal sampai tahap pengecoran, supaya pesantren ini bisa digunakan untuk para santri menginap.</p>\r\n\r\n<p>Karena untuk saat ini para santri masih tidur ditempat seadanya</p>'),
(2, 'Membantu nenek iroh untuk punya tempat tinggal yang layak', 'membantu-nenek-iroh-untuk-punya-tempat-tinggal-yang-layak', 3, 15000000, 2010000, 'Kiki Agustin', NULL, '2021-11-30 18:46:51', '2021-12-13 03:23:53', '<p>Nenek iroh adalah sebatang kara, dan beliau tidak punya tempat tinggal dan beliau bercita-cita ingin punya rumah sendiri</p>');
...
(4, 2, '2021-12-18', 'Pembelian Semen untuk pondasi', 1000000, NULL, '2021-12-02 10:03:28', '2021-12-12 01:11:48');
...
INSERT INTO `transactions` (`id`, `program_donations_id`, `nama_lengkap`, `email`, `jumlah_donasi`, `status_transaksi`, `doa`, `deleted_at`, `created_at`, `updated_at`, `samarkan`, `kategori_program`) VALUES
(1, 2, 'Kiki Agustin', 'kikiagustin62@gmail.com', 10000, 'PENDING', 'Doa untuk kalian semua', NULL, '2021-12-01 01:09:49', '2021-12-01 01:09:49', 1, 3),
(2, 1, 'Kiki Agustin', 'kikiagustin62@gmail.com', 100000, 'PENDING', 'Doa untuk kalian semua', NULL, '2021-12-13 03:21:52', '2021-12-13 03:21:52', 1, 2),
(3, 2, 'Dea Hasanatus Tsaniyah', 'dea@gmail.com', 2000000, 'PENDING', 'Semoga cepat selesai', NULL, '2021-12-13 03:23:53', '2021-12-13 03:23:53', 1, 3);
