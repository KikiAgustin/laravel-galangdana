...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2021 at 03:26 PM
...
(3, 'Haruskah anak kecil dijambuk ketika tidak mau sholat', 'haruskah-anak-kecil-dijambuk-ketika-tidak-mau-sholat', 1, '<p>sholat adalah kewajiban bagi setiap muslim, oleh karena itu apakah ketika anak tidak mau shoat harus kita jambuk?</p>\r\n\r\n<p>Gini teman-teman&nbsp;</p>', NULL, '2021-12-01 01:15:43', '2021-12-13 03:48:40', 'assets/gallery/blog/SsbfjrAQwxsb9X05eTyB8CAqnqxa6qg89K5kAhBV.jpg', 'Kiki Agustin', 'sholat adalah kewajiban bagi setiap muslim, oleh karena itu apakah ketika anak tidak mau shoat harus', 31);
...
(33, '2021_12_17_090206_add_invoice_field_to_transactions_table', 10);
...
(1, 'Pembangunan pesantren LKS Al-Hikmah Majalaya', 'pembangunan-pesantren-lks-al-hikmah-majalaya', 2, 50000000, 3000000, 'Kiki Agustin', NULL, '2021-11-30 18:44:43', '2021-12-17 03:17:45', '<p>Sudah satu tahun pembangunan wakaf pesantren terhenti, dikarenakan dana,nya tidak ada maka dari itu kami selaku panitia ingin mengajak para orang baik untuk membereskan pembangunan ini minimal sampai tahap pengecoran, supaya pesantren ini bisa digunakan untuk para santri menginap.</p>\r\n\r\n<p>Karena untuk saat ini para santri masih tidur ditempat seadanya</p>'),
(2, 'Membantu nenek iroh untuk punya tempat tinggal yang layak', 'membantu-nenek-iroh-untuk-punya-tempat-tinggal-yang-layak', 3, 15000000, 0, 'Kiki Agustin', NULL, '2021-11-30 18:46:51', '2021-12-14 02:02:40', '<p>Nenek iroh adalah sebatang kara, dan beliau tidak punya tempat tinggal dan beliau bercita-cita ingin punya rumah sendiri</p>');
...
(1, 1, 'Kiki Agustin', 'kikiagustin62@gmail.com', 2000000, 'PENDING', 'Doa untuk kalian semua', NULL, '2021-12-14 02:08:34', '2021-12-14 02:08:34', 0, 2, ''),
(2, 1, 'Mega Kusmayati', 'mega@gmail.com', 1000000, 'PENDING', 'Semoga cepat selesai', NULL, '2021-12-17 03:17:45', '2021-12-17 03:17:45', 0, 2, 'ALHIKMAH-202112172');
