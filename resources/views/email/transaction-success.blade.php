                          ...
                          <tbody>
                            <tr>
                              <td style="width:150px;">
                                <img alt="" height="auto" src="{{ url('frontend/assets/images/logo/logo.png') }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Playfair Display, Time New Roman, Serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#071C4D;">Terimakasih Orang Baik</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                          ...
                          <tbody>
                            <tr>
                              <td style="width:550px;">
                                <img alt="" height="auto" src="{{ url('frontend/assets/images/hero/bg-home.jpg') }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;text-align:left;color:#071C4D;">Hai, {{ $data->nama_lengkap }} <br><br> Donasi Kamu telah berhasil <br> Untuk <strong> {{ $data->program_donation->judul }} <strong></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4D;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                  ...
                                  <tr>
                                    <td>Tanggal</td>
                                    <td style="text-align:right;"> <strong> {{ date('d F Y', strtotime($data->created_at)) }}</strong></td>
                                  </tr>
                                  <tr>
                                    <td>Jumlah Donasi</td>
                                    <td style="text-align:right;"> <strong> Rp. {{ number_format($data->jumlah_donasi) }}</strong></td>
                                  </tr>
                                  <tr>
                                    <td>Nama Program</td>
                                    <td style="text-align:right;"> <strong>{{ $data->program_donation->judul }}</strong></td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="center" bgcolor="#FF9E53" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#FF9E53;" valign="middle">
                                        <p style="display:inline-block;background:#FF9E53;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;"> Cek Detail </p>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                          <tr>
                            <td style="width:50px">
                              <img src="{{ url('frontend/assets/images/logo/ic_support@2x.png') }}" width="50">
                            </td>
                            <td style="font-size: 18px; padding-left: 10px; color: #071C4D; font-family: Assistant, Helvetica, Arial, sans-serif"> support@lksalhikmah.id <br> 022333445677 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888B93;">2021 LKS Al-Hikmah Copyright All Rights Reserved</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
