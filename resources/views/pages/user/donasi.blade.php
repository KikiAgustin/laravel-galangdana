                    ...
                    <div class="content">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <form action="{{ route('donasiproses', $item->slug) }}"  method="POST" onsubmit="myFunction()" >
                                    @csrf
                                    <div class="mb-3">
                                      <label for="namalengkap" class="form-label">Nama Lengkap</label>
                                      <input type="text" name="namalengkap" class="form-control @error('namalengkap') is-invalid @enderror " placeholder="Silahkan Masukan Nama Lengkap Anda" id="namalengkap" value="{{@old('namalengkap')}}" required>
                                        @error('namalengkap')
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Silahkan Masukan Alamat Email" value="{{@old('email')}}" required>
                                        @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <button id="btn-donasi" class="btn btn-primary btn-donasi" type="submit" >
                                        {{-- <span class=" animasi-loading spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span> --}}
